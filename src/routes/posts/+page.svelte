...
<form method="post" action="?/create" class="grid grid-cols-1 gap-2 w-2/5 mx-auto my-8"> 
  ...
  <textarea name="abstract" placeholder="Prolog" class="border border-violet-700 py-1 px-3"></textarea>
  <textarea name="content" placeholder="Treść" class="border border-violet-700 py-1 px-3"></textarea>
